...
Command: npx gltfjsx@6.5.0 untitled.gltf --transform 
Files: untitled.gltf [387.79MB] > C:\Users\Marti\untitled-transformed.glb [11.26MB] (97%)
*/
...
export function Model(props) {
    ...
    return (
        ...
        <group {...props} dispose={null}>
            ...
            <mesh geometry={nodes.Victorian_Ink_Bottle.geometry} material={materials['Victorian Ink Bottle']} material-envMap={env} material-envMapIntensity={0.5} position={[-0.259, 0.928, -0.146]} rotation={[Math.PI, -1.213, Math.PI]}  />
                <mesh geometry={nodes.Scroll_LP.geometry} material={materials['01 - Default']} material-envMap={env} material-envMapIntensity={0.5} position={[-0.28, 0.878, -0.319]} scale={[0.016, 0.022, 0.016]} />
            </Select>
        ...
        <Text position={[0.5, 1.6, 0.5]} fontSize={0.5} letterSpacing={-0.05}>
                {hovered ? `Hovered: ${hovered}` : 'Not hovered'}
        </Text>
        <Price value={price} position={[0.5, 1.5, 0.5]} />
        </>
    )
}
